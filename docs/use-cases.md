...
2.2Сценарий А2: Загрузка некорректного файла.
  ...
  3)Показывается сообщение:
      "Неверный формат файла. Исправьте данные."
...
Ошибка Е1: Технический сбой / Internal Server Error
  ...
  3)Система отображает сообщение:
      "Произошла техническая ошибка. Повторите позже."
...
Ошибка Е3: Превышение размера загружаемого файла
  ...
  3)Показывается сообщение:
      "Прикрепляемый файл не может быть более 15МБ. Попробуйте уменьшить размер изображения."
  4)Система предлагает варианты решения (сжать файл, подождать).
...
![Uses Case диаграмма](docs/UsesCase.jpg)
